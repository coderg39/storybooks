...
router.get('/:id', ensureAuth, async (req, res) => {        // to use middleware, we include it as second param
    try {
...
router.put('/:id', ensureAuth, async (req, res) => {        // to use middleware, we include it as second param
    try {
...
router.delete('/:id', ensureAuth, async (req, res) => {        // to use middleware, we include it as second param
    try {
...
router.get('/user/:userId', ensureAuth, async (req, res) => {        // to use middleware, we include it as second param
    try {
